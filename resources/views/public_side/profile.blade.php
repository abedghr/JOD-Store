	...
	<div class="container">
		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				<h4>Categories</h4>
                    <ul>
                        <li><a href="{{route('public_provider.profile2',['id'=>$provider->id])}}" style="color:#2fdab8;"><strong>All Products</strong></a></li>
                    <?php $i= 0; ?>
			...
			<div class="community-poll">
				...
				<div class="swit form">	
					<form>
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio" onchange="vendor_filter_price('low-to-high')" checked=""><i></i>Low to High</label> </div></div>
