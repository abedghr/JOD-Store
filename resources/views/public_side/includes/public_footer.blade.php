		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t1.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t2.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t3.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t4.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t1.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t2.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t3.jpg')}}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{asset('pub_libraries/images/t2.jpg')}}" alt=" " class="img-responsive" /></a></li>
