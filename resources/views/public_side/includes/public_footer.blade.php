...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>J</span>ordan Stores </a></h2>
			<p>You can find everything that you want
				Make shopping from your best store.</p>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="{{route('product.all2')}}">Categories</a></li>
						<li><a href="{{route('provider.all2')}}">Stores</a></li>
						<li><a href="{{route('contact-us2')}}">Contact Us</a></li>
						<li><a href="{{route('order.tracking2')}}">Tracking Order</a></li>
						<li><a href="{{route('cart.index2')}}">Shopping Cart</a></li>
					</ul>
				</div>
					...
					<div class="w3-address">
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Phone Number</h6>
								<p>+962 79 071 4916 / +962 77 965 1174</p>
							</div>
		...
		<div class="clearfix"></div>
		<p class="copy-right">&copy 2020 Jordan stores. All rights reserved {{-- | Design by <a href="http://w3layouts.com/">W3layouts</a> --}}</p>
	</div>
</div>
<!-- //footer -->
...
<!-- //script for responsive tabs -->		
<!-- stats -->
	<script src="{{asset('/pub_libraries/js/jquery.waypoints.min.js')}}"></script>
	<script src="{{asset('/pub_libraries/js/jquery.countup.js')}}"></script>
	<script>
		$('.counter').countUp();
	</script>
<!-- //stats -->
