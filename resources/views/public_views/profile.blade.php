...
<!--================Home Banner Area =================-->
    <section class="bg-profile" style="margin-top: 122px; background-image: url('../../storage/Provider_coverImages/{{$provider->cover_image}}')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 text-center">
                <img src="../../storage/provider_images/{{$provider->image}}" class="rounded-circle" width="250" height="250" style="margin-top:-80px; padding:10px; border:1px solid silver" alt="">
            </div>
            <div class="col-lg-6">
                <small>{{$provider->store_type}}</small>
                <h1>{{$provider->name}}</h1>
                <hr>
            ...
            <div class="col-lg-3">
                ...
                <button class="btn btn-secondary  btn-block mt-2">Chat Us</button>
        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="product_top_bar">
                    <div class="left_dorp">
                        <input type="search" class="sorting" id="search" onkeyup="search_vendors_products()" style="width:335px !important" placeholder="Search ..">
                    </div>
    ...
    let old_data = $('.prod_content').html();
     function search_vendors_products(){
         ...
         if(data != ""){
             $.ajax({
                 type: "get",
                 url : "{{route('vendors_product.search')}}",
                 data:{
                     'data_search':data,
                     'prov_id':"{{$provider->id}}"
                 },
