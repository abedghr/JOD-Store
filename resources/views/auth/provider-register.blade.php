                        ...
                        <div class="card-body mt-5">
                            ...
                            <form method="POST"  action="{{ route('provider.register.submit') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="phone1" name="phone1" type="tel" pattern="[079]{3}[0-9]{7}|[078]{3}[0-9]{7}|[077]{3}[0-9]{7}" class="form-control @error('phone1') is-invalid @enderror"  placeholder="Enter your mobile number">
                                    @error('phone1')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
