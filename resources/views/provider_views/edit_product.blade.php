        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{route('product_provider.update',['id'=>$product->id])}}"  enctype="multipart/form-data" >
                @csrf
                @method('put')
                <div class="card-body">
      ...
      <div class="card-body p-0 table-responsive">
        <table class="table text-center">
          ...
          <tbody>
              ...
              <tr>
                <td>
                <img src="../../img/Product_images/{{$image->image}}" width="100%" height="100%" class="rounded" alt="">
                </td>
                <td>
